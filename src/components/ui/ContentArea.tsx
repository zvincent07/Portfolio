...
// Experience Icons
const BriefcaseIcon = ({ className = "w-4.5 h-4.5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if ((e.ctrlKey || e.metaKey) && e.key === "Enter") {
        if (formRef.current && !loading && !success) {
    ...
    <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-xl bg-zinc-900/50 border border-zinc-800 flex items-center justify-between group hover:border-blue-500/30 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xs text-zinc-500 font-mono">/usr/bin/email</span>
                <span className="text-sm text-zinc-200 font-bold">zvincent.dev@gmail.com</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 text-zinc-500 text-xs font-mono pt-2">
            ...
            <span>System Status: <span className="text-emerald-500">Online</span> & Ready</span>
          </div>
        </div>
        ...
        <form ref={formRef} onSubmit={sendEmail} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs text-zinc-500 font-mono ml-1">var name =</label>
              <input 
                type="text" 
                name="user_name" 
                required
            ...
            <div className="space-y-1">
              <label className="text-xs text-zinc-500 font-mono ml-1">var email =</label>
              <input 
                type="email" 
                name="user_email" 
                required
          ...
          <div className="space-y-1">
            <label className="text-xs text-zinc-500 font-mono ml-1">var message =</label>
            <textarea 
              name="message" 
              required
              rows={4}
          ...
          <button 
            ...
            className={`w-full flex items-center justify-center gap-2 p-3 rounded-lg font-bold transition-all text-sm ${
              success 
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <span className="text-xs font-normal opacity-70 hidden sm:inline-block ml-1">(Ctrl+Enter)</span>
              </>
            )}
          </button>
        </form>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { name: 'PostgreSQL', color: 'bg-blue-700/20 text-blue-300 border-blue-700/40', icon: <PostgresIcon /> },
                { name: 'MySQL', color: 'bg-orange-600/20 text-orange-300 border-orange-600/40', icon: <MySQLIcon /> },
                { name: 'Python', color: 'bg-yellow-500/20 text-yellow-300 border-yellow-500/40', icon: <PythonIcon /> },
                { name: 'Git', color: 'bg-gray-600/20 text-gray-300 border-gray-600/40', icon: <GitIcon /> },
              ].map((skill) => (
                <span key={skill.name} className={`px-3 py-1.5 ${skill.color} border rounded-lg text-xs font-medium flex items-center gap-1.5`}>
                  {skill.icon}
                  {skill.name}
      ...
      <div className="space-y-8">
        ...
        <div className="relative border-l border-zinc-800 ml-3 space-y-12">
          ...
          <div className="relative pl-8 group">
            ...
            <h3 className="text-xl font-bold text-white">Bachelor of Science in Information Technology</h3>
            <p className="text-blue-400 font-medium mt-1">Major in Business Analytics</p>
            <p className="text-zinc-500 text-sm mt-1">Batangas State University</p>

            <p className="text-zinc-400 mt-4 leading-relaxed max-w-2xl">
              Specialized in data-driven decision making and software engineering. 
              Bridged the gap between raw data and actionable business insights through full-stack development.
            </p>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {[
                ...
                <div key={course} className="flex items-center gap-1.5 px-3 py-1 bg-zinc-900 border border-zinc-800 rounded-md text-xs text-zinc-300 hover:text-white hover:border-zinc-700 transition-colors cursor-default">
          ...
          <div className="relative pl-8 group">
            ...
            <h3 className="text-xl font-bold text-white">Senior High School Diploma</h3>
            <p className="text-purple-400 font-medium mt-1">Science, Technology, Engineering & Mathematics (STEM)</p>
            <p className="text-zinc-500 text-sm mt-1">The Mabini Academy</p>

            <p className="text-zinc-400 mt-4 leading-relaxed max-w-2xl">
              Built a strong foundation in logic, calculus, and scientific research methods, 
              preparing for intensive technical coursework in university.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="group bg-zinc-900/20 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all overflow-hidden">
          <div className="grid md:grid-cols-12 gap-0">
            ...
            <div className="md:col-span-5 p-6 flex flex-col justify-between border-b md:border-b-0 md:border-r border-zinc-800/50 bg-zinc-900/20">
              <div>
                <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">InvenTrack</h3>
                <p className="text-zinc-500 text-sm mb-4">GSO Inventory Management System</p>
                
                {/* Tags */}
                <div className="flex flex-wrap gap-2 mb-6">
                  {['PostgreSQL','Express.js','React.js','Node.js','Tailwind CSS', 'RBAC', 'Analytics'].map((tag) => (
                    <span key={tag} className="text-[10px] font-medium px-2 py-1 rounded bg-zinc-800 text-zinc-400 border border-zinc-700">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              {/* Links */}
              <div className="flex gap-3">
                <a href="https://inventrackgso.onrender.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black text-xs font-bold hover:bg-zinc-200 transition-colors">
            ...
            <div className="md:col-span-7 p-6 flex flex-col justify-center">
              <div className="space-y-4 text-sm leading-relaxed">
                <div>
                  <span className="text-red-400 font-bold uppercase tracking-wider text-xs">The Challenge:</span>
                  <p className="text-zinc-400 mt-1">
                    The GSO faced difficulties with <span className="text-zinc-200">manual inventory monitoring</span>, leading to data redundancy, inaccurate stock records, and time-consuming report generation during audits.
                  </p>
                </div>
                <div>
                  <span className="text-emerald-400 font-bold uppercase tracking-wider text-xs">The Fix:</span>
                  <p className="text-zinc-400 mt-1">
                    A centralized <strong>Web-Based Inventory System</strong> that digitizes the entire asset lifecycle. Features <span className="text-zinc-200">real-time stock level monitoring</span>, instant item search/filtering, and <strong>automated report generation</strong> for seamless auditing.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="group bg-zinc-900/20 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all overflow-hidden">
          <div className="grid md:grid-cols-12 gap-0">
            ...
            <div className="md:col-span-5 p-6 flex flex-col justify-between border-b md:border-b-0 md:border-r border-zinc-800/50 bg-zinc-900/20">
              <div>
                <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">QRoom</h3>
                <p className="text-zinc-500 text-sm mb-4">Campus Room Management</p>
                
                {/* Tags */}
                <div className="flex flex-wrap gap-2 mb-6">
                  {['MySQL', 'Express.js', 'React.js', 'Node.js', 'Bootstrap', 'RBAC', 'Real-time API'].map((tag) => (
                    <span key={tag} className="text-[10px] font-medium px-2 py-1 rounded bg-zinc-800 text-zinc-400 border border-zinc-700">
                      {tag}
                    </span>
                  ))}
              ...
              {/* Links */}
              <div className="flex gap-3">
                <a href="https://qroom-omega.vercel.app/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black text-xs font-bold hover:bg-zinc-200 transition-colors">
                  View Live <ExternalLinkIcon className="w-3.5 h-3.5" />
                </a>
              </div>
            </div>
            ...
            <div className="md:col-span-7 p-6 flex flex-col justify-center">
              <div className="space-y-4 text-sm leading-relaxed">
                <div>
                  <span className="text-red-400 font-bold uppercase tracking-wider text-xs">The Challenge:</span>
                  <p className="text-zinc-400 mt-1">
                    Campuses struggle with <span className="text-zinc-200">lack of visibility on room availability</span>, making it hard to schedule classes or track room conditions.
                  </p>
                </div>
                <div>
                  <span className="text-emerald-400 font-bold uppercase tracking-wider text-xs">The Fix:</span>
                  <p className="text-zinc-400 mt-1">
                    A centralized dashboard with <strong>QR scanning</strong> for instant room status. Features a <span className="text-zinc-200">utilization analytics board</span> and condition reporting module.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {/* SoundSprint */}
          <a href="https://github.com/xKobeni/SoundSprint" target="_blank" rel="noopener noreferrer" className="block p-5 rounded-xl border border-zinc-800/50 hover:bg-zinc-900/40 hover:border-zinc-700 transition-all group">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-zinc-900 rounded-lg border border-zinc-800">
                  <SmartphoneIcon className="w-4.5 h-4.5 text-blue-400" />
                </div>
                <h4 className="font-bold text-zinc-300 group-hover:text-white">SoundSprint</h4>
              </div>
            ...
            <p className="text-xs text-zinc-500 leading-relaxed mb-3 line-clamp-2">
              Flutter mobile app. Contributed to UI state management and cross-platform responsive layouts.
            </p>
            <div className="flex gap-2">
              {['Flutter', 'Dart', 'Mobile'].map((tag) => (
                <span key={tag} className="text-[10px] uppercase tracking-wider text-zinc-600 font-semibold">{tag}</span>
              ))}
            </div>
          </a>

          {/* RBAC Admin Dashboard */}
          <a href="https://github.com/zvincent07/Login-Admin-Dashboard-Themeplate" target="_blank" rel="noopener noreferrer" className="block p-5 rounded-xl border border-zinc-800/50 hover:bg-zinc-900/40 hover:border-zinc-700 transition-all group">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-zinc-900 rounded-lg border border-zinc-800">
                  <LayoutDashboardIcon className="w-4.5 h-4.5 text-purple-400" />
                </div>
                <h4 className="font-bold text-zinc-300 group-hover:text-white">RBAC Admin Dashboard</h4>
              </div>
              <ExternalLinkIcon className="w-3.5 h-3.5 text-zinc-600 group-hover:text-white" />
            </div>
            <p className="text-xs text-zinc-500 leading-relaxed mb-3 line-clamp-2">
              Open-source MERN boilerplate with secure Role-Based Access Control and JWT authentication.
            </p>
            <div className="flex gap-2">
      ...
      <div className="relative space-y-12">
        ...
        <div className="absolute left-3 top-0 bottom-0 w-0.5">
          ...
          <div 
            ...
            style={{
              ...
              background: 'linear-gradient(to bottom, rgba(59, 130, 246, 0.6) 0%, rgba(59, 130, 246, 0.3) 50%, rgba(59, 130, 246, 0.1) 100%)'
            }}
          />
        ...
        <div className="relative pl-8 group experience-glow">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
            <h3 className="text-lg font-bold text-white">Freelance Technical Consultant</h3>
          ...
          <p className="text-zinc-500 text-sm mb-4">Self-Employed • Various Clients</p>

          <p className="text-zinc-400 leading-relaxed mb-6 text-sm">
            Providing on-demand technical solutions for students and small businesses. 
            I handle diverse tasks requiring quick adaptation to different tools and technologies.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="px-3 py-2 rounded-lg bg-blue-500/5 border border-blue-500/10 hover:bg-blue-500/10 hover:border-blue-500/20 transition-all">
              <h4 className="font-mono text-xs font-semibold text-blue-300 mb-1">Technical Research & Docs</h4>
              <p className="text-xs text-zinc-400 leading-snug">Assisting with academic papers, system documentation, and requirements analysis.</p>
            </div>

            <div className="px-3 py-2 rounded-lg bg-blue-500/5 border border-blue-500/10 hover:bg-blue-500/10 hover:border-blue-500/20 transition-all">
              <h4 className="font-mono text-xs font-semibold text-blue-300 mb-1">Network Engineering</h4>
              <p className="text-xs text-zinc-400 leading-snug">Configuring topologies and simulations in Cisco Packet Tracer.</p>
            </div>

            <div className="px-3 py-2 rounded-lg bg-blue-500/5 border border-blue-500/10 hover:bg-blue-500/10 hover:border-blue-500/20 transition-all">
              <h4 className="font-mono text-xs font-semibold text-blue-300 mb-1">Scripting & Automation</h4>
              <p className="text-xs text-zinc-400 leading-snug">Data processing tasks using Python and Google Colab.</p>
            </div>

            <div className="px-3 py-2 rounded-lg bg-blue-500/5 border border-blue-500/10 hover:bg-blue-500/10 hover:border-blue-500/20 transition-all">
              <h4 className="font-mono text-xs font-semibold text-blue-300 mb-1">UI/UX Design</h4>
              <p className="text-xs text-zinc-400 leading-snug">Creating prototypes and wireframes in Figma.</p>
            </div>
          </div>
        </div>
